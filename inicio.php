...
<main class="container1">
  <div class="content1">
    ...
    <p>Este site foi desenvolvido como parte do curso de Desenvolvimento de Sistemas no SENAI Taubaté, com o propósito de fornecer informações detalhadas sobre a formação, suas disciplinas, oportunidades e impactos no mercado de trabalho.</p>

    <p>Mais do que uma simples apresentação do curso, este espaço funciona como um repositório de conhecimento, reunindo conteúdos essenciais para alunos, ex-alunos e futuros profissionais.</p>

    <p>Aqui, é possível encontrar materiais de estudo, projetos desenvolvidos durante o curso, depoimentos de estudantes e professores, além de notícias e tendências do setor da tecnologia.</p>

    <p>Nosso objetivo é criar um ambiente de aprendizado contínuo, onde os visitantes possam se manter atualizados sobre as inovações da área, explorar diferentes caminhos dentro do universo do desenvolvimento de sistemas e se preparar para os desafios do mercado de trabalho. Seja você um estudante em busca de recursos para aprimorar seus conhecimentos ou alguém interessado em ingressar nesse campo promissor, este site foi feito para apoiar sua jornada na tecnologia.</p>
  </div>
</main>
